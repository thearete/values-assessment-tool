/**
 * Shared Utilities — SVG icons, formatters, helpers
 */
...
const ICONS = {
  ...
  newspaper: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 20H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v1m2 13a2 2 0 0 1-2-2V7m2 13a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-2"/></svg>',
  gavel: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 2l5 5-7 7-5-5z"/><path d="M3 21l4-4"/><path d="M8.5 8.5l-3 3"/></svg>',
 ...
 * "2026-02-17T20:14:05.613Z" → "Feb 17, 2026"
 */
 ...
 * "2026-02-17T20:14:05.613Z" → "Feb 17, 2026 at 8:14 PM"
 */
...
/**
 * Get the human-readable flag label.
 */
...
/**
 * Get the icon name for an evidence source type.
 */
function getEvidenceIcon(sourceType) {
  const map = {
    government: 'shield',
    court: 'gavel',
    news: 'newspaper',
  ...
  return map[sourceType] || 'alertTriangle';
}
